# OPEN ACCESS FAMILY CENSUS v04 (WAVE-3 RE-VERIFICATION)

---
name: Open-access long-read family census v04
description: Saturated census of publicly downloadable human families with long-read WGS (complete families only). Built by Q38 census branch from 4 wave-1 search agents, 3 wave-2 agents, and wave-3 direct verification (DeepSeek Codex session) against ENA, NCBI, SRA, AWS S3, GIAB FTP, Europe PMC full text, bioRxiv, NGDC GSA-Human/GWH, BIG Search, and GitHub. v04 adds no new families and REMOVES T2T-CQ (F16): live GSA-Human records and the GPB paper methods prove the parents have short-read Illumina only.
type: project
last_edited: 2026-08-06 by Codex (Q38 branch, wave-3)
status: SATURATED after wave-3, with one correction (T2T-CQ removed). v01, v02, and v03 preserved for history.
---

# TLDR

32 unique open-access complete families (34 complete trios) have long-read WGS data publicly downloadable today. Wave-3 (direct verification, 2026-08-06) found ZERO new open families: every remaining lead was verified as controlled (duoNovo/GREGoR 38 trios + 2 quads, Quartet PGT 13 quartets, autism methylome 31 quartets, REACH 63-family autism, Central Asian GVM000900), short-read only (PRJNA477862, paternal-age study), or unresolved-but-not-counted (Zhou 2026, CQ-chrY, Kramer/McCombie). Wave-3 also made one CORRECTION: T2T-CQ (F16, counted in v01-v03) is removed because the parents (LCL7/LCL8) have short-read Illumina only, verified in the GPB paper methods and in live GSA-Human records (HRA010594 holds only the twins' ONT ultralong + Hi-C; HRA001859 is all short-read multi-omics; HRA003188 is LCL5 ONT only; NCBI SRA has no parent long reads). The twins' T2T diploid assembly (GWHFQEY00000000.1 / GWHFQEX00000000.1) remains open at GWH but covers only 2 of 4 members. The counted families stand: 13 manifest (HGSVC3/LRSC/Vienna), 2 GIAB trios, PAN027/WashU pedigree, 15 Platinum Pedigree family units, and the Arab Pangenome Reference trio (F33, the only fully non-cultured open family). Note for Max: the remembered number 17 = 13 + 2 GIAB + T2T-CQ + PAN027; T2T-CQ is now removed, so the census total is 32 without it.
...
| Complete trios across them | 34 |
| Families with assemblies downloadable for ALL members | 24 (HGSVC3 F01-F03, LRSC F04-F07, PAN027 F17, Platinum Pedigree F18-F32, APR F33) |
| Families with partial assemblies | 1 (GIAB Ashkenazi: HG002 T2T only) |
| Families with reads only | 7 (Vienna F08-F13, GIAB Chinese F15) |
...
## Group III: T2T reference families (1 counted family; F16 T2T-CQ removed in v04)

F16 - T2T-CQ Chinese Quartet (chinese-quartet.org) - REMOVED FROM CENSUS in v04 (counted in v01-v03 as 2 trios). Reason: not a complete long-read family. Verified 2026-08-06:
- Members: two monozygotic twin DAUGHTERS (LCL5, LCL6) + biological parents (LCL7 father, LCL8 mother). Han Chinese. Material: B-lymphoblastoid cell lines.
- Parents: short-read Illumina ONLY. Paper methods (PMC13075991): "Parental datasets, consisting of Illumina PCR-free paired-end sequences, were obtained from LCL7 (father) and LCL8 (mother)." No parent long-read WGS exists in GSA-Human (HRA001859 is all short-read multi-omics; HRA003188 is LCL5 ONT only; HRA010594 is twins only) or in NCBI SRA.
- Twins: ONT ultralong + Hi-C in GSA-Human HRA010594 (28 runs, controlled); earlier LCL5 ONT WGS in HRA003188 (2019); HiFi per paper. Raw reads controlled (GSA-Human DAC).
- Assemblies: CQ v2.0 AND CQ v3.2 are BOTH the twins' combined diploid genome (2 haplotypes), not parent assemblies. Open at GWH: GWHFQEY00000000.1 (maternal haplotype), GWHFQEX00000000.1 (paternal haplotype). Twins-only; does not cover the parents.
- Full dead-end record in section 7.
...
4. ~~F16 T2T-CQ~~ REMOVED in v04: twins-only T2T diploid (GWHFQEY00000000.1 / GWHFQEX00000000.1 open at GWH); parents short-read only; not a complete family (see section 7)
...
- T2T-CQ (REMOVED in v04): GPB paper methods confirm the parents contributed Illumina PCR-free paired-end only. GSA-Human AJAX endpoints (live, 2026-08-06): HRA010594 = LCL5 + LCL6 only (28 runs: ONT ultralong PromethION + Hi-C MGISEQ-2000); HRA003188 = LCL5 only (9 ONT PromethION WGS runs); HRA001859 = all four members but 2,042 runs, all short-read (no WGS-strategy runs, no long reads). NCBI SRA searches for LCL7/LCL8 return false positives only (plant 16S metagenome etc.).
...
- T2T-CQ (removed in v04): B-lymphoblastoid cell lines throughout (confirmed); parents short-read only.
