"""
mdindex_sync.py v04 | 2026-04-13 19:20
Syncs _tomemex.md files to Memex ingest folder.
    ...
    for root, max_depth in roots:
        ...
        for md_file in root.rglob("*_tomemex.md"):
            ...
            if "00_clawy_kb" in md_file.parts:
                continue
            # Skip git worktrees / repo internals: each Claude Code session
            # makes a full-repo worktree under .claude, so scanning them
            # collected ~123 duplicate copies of every _tomemex.md doc.
